...
using ECommerceApp.Business.EntityFramework.Domain.Catalog;
using ECommerceApp.DataAccess.Abstract.Domain.Catalog;
using ECommerceApp.DataAccess.EntityFramework;
using ECommerceApp.DataAccess.EntityFramework.Domain.Catalog;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AppDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("ECommerceConnection")
                    , m => m.MigrationsAssembly("ECommerce.Api")
                )
            );
